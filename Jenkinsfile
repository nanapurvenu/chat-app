        ...
        stage('build frontend') {
            steps {
                script {
                    ...
                    sh 'cd chat-app/frontend && docker build -t venureddy3417/chatapp-fe:${packageJSONVersion} . && docker container run -dt --name chatapp-frontend -p 80:80 venureddy3417/chatapp-fe:${packageJSONVersion}'
                }
            }
        }
